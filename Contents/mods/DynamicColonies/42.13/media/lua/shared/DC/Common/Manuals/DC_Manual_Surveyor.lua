...
--   "title": "Surveyor's Planning Guide",
--   "description": "Architect's notes on plotting structures, resource recipes, and powering the colony grid.",
--   "start_page_id": "building_projects",
--   "chapters": [
--     { "id": "construction_logistics", "title": "Structural Planning", "description": "Managing building projects, work points, and material recipes." },
--     { "id": "energy_infrastructure", "title": "Power & Logistics", "description": "Fueling the colony and managing energy consumption." }
--   ],
--   "pages": [
--     {
