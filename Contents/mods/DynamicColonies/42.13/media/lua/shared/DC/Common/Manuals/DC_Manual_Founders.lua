...
--   "title": "The Founder's Handbook",
--   "description": "A leadership guide to establishing your site, recruiting labor, and the cycle of work.",
--   "start_page_id": "founding_intro",
--   "chapters": [
--     { "id": "site_management", "title": "Establishing a Site", "description": "Finding the right ground and claiming it for your people." },
--     { "id": "roster_jobs", "title": "Managing the Roster", "description": "Assigning roles and overseeing the daily simulation cycle." }
--   ],
--   "pages": [
--     {
--       "id": "founding_intro",
