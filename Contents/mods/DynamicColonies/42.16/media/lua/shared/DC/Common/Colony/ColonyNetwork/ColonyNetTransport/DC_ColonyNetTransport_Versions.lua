...
function Transport.buildFactionStatusSummary(ownerUsername)
    ...
    return {
        ...
        needsNamingPrompt = fullStatus.needsNamingPrompt == true,
        ...
        faction = faction and {
            ...
            town = faction.town,
            baseConfigured = faction.baseConfigured == true,
            homeCoords = type(faction.homeCoords) == "table" and {
                x = faction.homeCoords.x,
                y = faction.homeCoords.y,
                z = faction.homeCoords.z,
                name = faction.homeCoords.name,
                town = faction.homeCoords.town,
                baseConfigured = faction.homeCoords.baseConfigured == true,
            } or nil,
...
function Transport.getFactionStatusVersion(ownerUsername)
    ...
    return table.concat({
        ...
        tostring(faction.town or "none"),
        tostring(faction.baseConfigured == true),
        tostring(faction.homeCoords and faction.homeCoords.name or "none"),
        tostring(faction.homeCoords and faction.homeCoords.x or "none"),
        tostring(faction.homeCoords and faction.homeCoords.y or "none"),
        tostring(faction.homeCoords and faction.homeCoords.z or "none"),
        tostring(summary.needsNamingPrompt == true),
