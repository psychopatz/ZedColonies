...
function Bridge.ResolveWorkAnchor(worker, homeTarget)
    ...
    elseif normalizedJob == tostring(jobTypes.Guard or "Guard")
        and DC_ZoneRealBase and DC_ZoneRealBase.ResolvePatrolAnchorTarget then
        target = DC_ZoneRealBase.ResolvePatrolAnchorTarget(worker)
        workMode = "job"
    ...
    elseif normalizedJob == tostring(jobTypes.Gatherer or "Gatherer") and DC_ZoneRealBase and DC_ZoneRealBase.ResolveGathererTarget then
        ...
        workMode = "job"
    elseif normalizedJob == tostring(jobTypes.ChopTrees or "ChopTrees")
        and DC_ZoneRealBase and DC_ZoneRealBase.ResolveChopTreesTarget then
        target = DC_ZoneRealBase.ResolveChopTreesTarget(worker)
        workMode = "job"
    elseif normalizedJob == tostring(jobTypes.CorpseRemoval or "CorpseRemoval")
        and DC_ZoneRealBase and DC_ZoneRealBase.ResolveGraveyardTarget then
        target = DC_ZoneRealBase.ResolveGraveyardTarget(worker)
        workMode = "job"
