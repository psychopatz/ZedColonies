...
local COMMAND_ICON_PATH = "media/ui/Emotes/DC_EmoteMenu.png"
local ORDER_ICON_PATHS = {
    Follow = "media/ui/Emotes/DC_EmoteFollow.png",
    Stay = "media/ui/Emotes/DC_EmoteStay.png",
    ProtectAuto = "media/ui/Emotes/DC_EmoteProtectAuto.png",
    ProtectMelee = "media/ui/Emotes/DC_EmoteProtectAuto.png",
    ProtectRanged = "media/ui/Emotes/DC_EmoteProtectAuto.png",
    Dismiss = "media/ui/Emotes/DC_EmoteGoHome.png",
}
