...
function Internal.buildWorkerSupplyEntry(entry, index)
    ...
    return {
        ...
        itemID = entry.itemID,
        ledgerIndex = index,
        displayName = entry.displayName or Internal.getDisplayNameForFullType(entry.fullType),
        ...
        totalCalories = tonumber(entry.totalCaloriesRemaining) or (caloriesPerItem * qty),
        totalHydration = tonumber(entry.totalHydrationRemaining) or (hydrationPerItem * qty),
        totalTreatmentUnits = tonumber(entry.totalTreatmentUnitsRemaining) or (treatmentPerItem * qty),
        qty = qty,
